    ...
    <React.Fragment>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          ...
          <hr/>
          <Typography gutterBottom>{nombre} {apellido}</Typography>
          <Typography gutterBottom>{direccion}</Typography>
          <Typography gutterBottom>{direccionOpcional}</Typography>
        </Grid>
        <Grid item container direction="column" xs={12} sm={6}>
          ...
          <hr/>
          <Grid container>
          <React.Fragment key={pago}>
                <Grid item xs={6}>
                  <Typography gutterBottom>Metodo: {pago}</Typography>
                </Grid>
                {/* <Grid item xs={6}>
